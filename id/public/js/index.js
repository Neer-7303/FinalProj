...
Moralis.initialize("tfuQ8qhyUVeXbrGRekiXIhcZo1xNSWkMcmYoquHN"); // APP ID
Moralis.serverURL = "https://7tdv4xeguei0.usemoralis.com:2053/server";
...
async function uploadfile(user,doctype,docnum,name,file){
  ...
  // storing on ledger
    const contractAddress = "0x45dFb6d25b4bfa08FeAF5d246055f893225EE023";
